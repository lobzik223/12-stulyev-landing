  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 text-gray-900 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-gray-900 to-transparent overflow-hidden torn-edge-animated" 
        ...
        {/* Плавные анимированные частицы */}
        <div className="absolute inset-0">
          <div className="absolute top-4 left-1/4 w-1.5 h-1.5 bg-amber-400/40 rounded-full particle-animated"></div>
          <div className="absolute top-6 right-1/3 w-1 h-1 bg-amber-300/50 rounded-full particle-float" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-8 left-1/2 w-1.5 h-1.5 bg-amber-500/30 rounded-full particle-animated" style={{animationDelay: '2s'}}></div>
          <div className="absolute top-2 right-1/4 w-1 h-1 bg-amber-400/60 rounded-full particle-float" style={{animationDelay: '3s'}}></div>
          
          {/* Дополнительные мягкие частицы */}
          <div className="absolute top-3 left-1/6 w-1 h-1 bg-amber-600/50 rounded-full particle-float" style={{animationDelay: '0.5s'}}></div>
          <div className="absolute top-7 right-1/6 w-1 h-1 bg-amber-300/70 rounded-full particle-animated" style={{animationDelay: '1.5s'}}></div>
          <div className="absolute top-5 left-2/3 w-1.5 h-1.5 bg-amber-500/35 rounded-full particle-float" style={{animationDelay: '2.5s'}}></div>
          <div className="absolute top-1 right-1/2 w-1 h-1 bg-amber-400/45 rounded-full particle-animated" style={{animationDelay: '3.5s'}}></div>
        </div>
      </div>
    </section>
  );
